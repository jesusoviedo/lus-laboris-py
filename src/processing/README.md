...
|--------|-------------|--------|
| `extract_law_text.py` | Script principal para extraer y procesar el texto del Código Laboral de Paraguay desde su fuente oficial | ✅ Activo |
...
Puedes construir y ejecutar el script en un contenedor Docker para máxima portabilidad.
